...
// var productsDiv = document.getElementById('main-div');
...
//     var image = `<img src="./src/img/${selectValue}.png">`;
//     productsDiv.innerHTML = image;
// }
//     for (let j = 0; j <products[i].reviews.length; j++) {

//       if(products[i].title ==  selectValue){
// var cards = document.createElement("div")
// cards.style.backgroundColor = "pink"
// cards.style.width = "20%";
// var html = `<div class="card-main-div">
//             <div class="create"> <h5> Reviewer Name : ${products[i].reviews[j].reviewerName}</h5>
//             <h5> Rating : ${products[i].reviews[j].rating}</h5>
//             <h5> Comment : ${products[i].reviews[j].comment}</h5>
//             <h5> Date : ${products[i].reviews[j].date}</h5>
//             <h5> Reviewer Email : ${products[i].reviews[j].reviewerEmail}</h5></div></div>`;
// // mascara.innerText += products[i].reviews[j]
...
dropdown.addEventListener("change", function () {
  var selectValue = dropdown.value;
  productsDiv.innerHTML = ""; // clear the previous content
  if (selectValue == "select product"){
        ...
        if (products[i].title == selectValue) {
          ...
          card.innerHTML = `
            <div class="card-main-div">
              <div class="create">
                <h5>Reviewer Name: ${products[i].reviews[j].reviewerName}</h5>
                <h5>Rating: ${products[i].reviews[j].rating}</h5>
                <h5>Comment: ${products[i].reviews[j].comment}</h5>
                <h5>Date: ${products[i].reviews[j].date}</h5>
                <h5>Reviewer Email: ${products[i].reviews[j].reviewerEmail}</h5>
                <h5>Description: ${products[i].description}</h5>
                <img src="./src/img/${selectValue}.png">
              </div>
